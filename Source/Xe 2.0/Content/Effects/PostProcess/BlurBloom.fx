...
//Alpha value
float alpha;
// to fix : bloomatic.Parameters["alpha"].SetValue((float)(Math.Cos(alphaFrame) * 0.5 + 0.5));
// and		alphaFrame += (gameTime.ElapsedGameTime.TotalSeconds * 2.0);

//Operate on a high range (0.5 - 1.0) or the full range (0.0 - 1.0)
// dont forget to combine if true
bool hirange = false;
