...
{
    public class Rect : Sprite, IPhysical, ICollidable
    {
        #region Members
        ...
        public List<Vector> Vertices
        {
            get
            {
                if (m_collisions != null)
                    return m_collisions.MakeBox(m_position.ToPoint(), new Rectangle((int)this.X, (int)this.Y, this.Width, this.Height));
