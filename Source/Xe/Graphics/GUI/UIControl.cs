...
namespace Xe.GUI
{
    ...
    public class UIControl : Microsoft.Xna.Framework.DrawableGameComponent
    {
        #region Members
...
#if DEBUG
				m_spriteBatch.DrawString(m_font, str.Substring(0, nChars), vAt, cText, 0, Vector2.Zero, 1, SpriteEffects.None, 0);
#else
				try
				{
