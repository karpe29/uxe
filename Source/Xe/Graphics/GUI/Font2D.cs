...
namespace Xe.GUI
{
	...
	public class Font2D : Microsoft.Xna.Framework.GameComponent
	{
        ...
        {
            DrawTextBox(fontName, text, TextAlign.Left, TextAlignVertical.Top, BreakStyle.Word, new Rectangle((int)position.X, (int)position.Y, (int)size.X, (int)size.Y), color);
        }
        ...
        {
            DrawTextBox(fontName, text, 0, TextAlign.Left, TextAlignVertical.Top, BreakStyle.Letter, box, color);
        }
        ...
        {
			DrawTextBox(fontName, text, 0, align, TextAlignVertical.Top, BreakStyle.Letter, new Rectangle((int)position.X, (int)position.Y, (int)size.X, (int)size.Y), color);
        }
        ...
        {
			DrawTextBox(fontName, text, 0, align, TextAlignVertical.Top, BreakStyle.Letter, box, color);
        }

        public void DrawTextBox(string fontName, string text, int lineIndex, TextAlign align, TextAlignVertical alignVertical, Rectangle box, Color color)
        {
			DrawTextBox(fontName, text, lineIndex, align, alignVertical, BreakStyle.Word, box, color);
        }
		*/
		/// <summary>
		/// Draws a TextBox
		...
		/// <param name="box">The rectangle parameters of the TextBox.</param>
		/// <param name="color">The Color of the text.</param>
		public void DrawTextBox(string fontName, string text, TextAlign align, TextAlignVertical alignVertical, BreakStyle breakStyle, Rectangle box, int cornerSize, Color color)
		{
			DrawTextBox(fontName, text, 0, align, alignVertical, breakStyle, box, cornerSize, color);
		}

		public void DrawTextBox(string fontName, string text, int lineIndex, TextAlign align, TextAlignVertical alignVertical, BreakStyle breakStyle, Rectangle box, int cornerSize, Color color)
		{
			DrawTextBox(fontName, text, lineIndex, 0, align, alignVertical, breakStyle, box, cornerSize, color);
		}

		public void DrawTextBox(string fontName, string text, int lineIndex, int charIndex, TextAlign align, TextAlignVertical alignVertical, BreakStyle breakStyle, Rectangle box, int cornerSize, Color color)
		{
			// If the font doesn't exist, don't bother
			if (!m_fonts.ContainsKey(fontName))
				return;
