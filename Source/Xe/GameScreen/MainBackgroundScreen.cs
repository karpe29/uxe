...
namespace XeFramework.GameScreen
{
	class MainBackgroundScreen : IGameScreen
	{
		...
		protected override void LoadGraphicsContent(bool loadAllContent)
		{
			...
			myEffect = GameScreenManager.ContentManager.Load<Effect>(@"Content\Effects\MrWiggle");
			...
			myTexture = GameScreenManager.ContentManager.Load<Texture2D>(@"Content\Textures\wedge_p1_diff_v1");
