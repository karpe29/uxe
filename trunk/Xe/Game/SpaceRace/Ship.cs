...
namespace XeFramework.XeGame.SpaceRace
{
	...
	class Ship : DrawableGameComponent
	{
		...
		protected override void LoadGraphicsContent(bool loadAllContent)
		{
			...
			if (loadAllContent)
			{
				m_model = m_gameScreen.GameScreenManager.ContentManager.Load<Model>(@"Content\Models\WormHole");
			}
		...
		public override void Draw(GameTime gameTime)
		{
			...
			this.GraphicsDevice.RenderState.CullMode = CullMode.None; // ONLY for the wormhole :)
