...
namespace Xe.GameScreen
{
	class CreditsScreen : IGameScreen
	{
			...
			: base(gameScreeManager, true)
		{
			...
			XeGame.GuiManager.AddControl(m_labelGameName);
			...
			XeGame.GuiManager.AddControl(m_labelLoulou);
			...
			XeGame.GuiManager.AddControl(m_labelJB);
			...
			XeGame.GuiManager.AddControl(m_labelClick);
		}
